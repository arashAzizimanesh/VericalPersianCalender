...
public class CalenderView extends LinearLayout implements UiCalender {
    ...
    public static int SKEP_MONTH = 6;
    ...
    private void getAttrs(AttributeSet attributeSet) {
        ...
        SKEP_MONTH = a.getInteger(R.styleable.CalenderView_skipMonth, 6);
    ...
    public void initView() {
        ...
        calenderPresentor.getCalenderData(SKEP_MONTH);
